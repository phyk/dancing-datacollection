...
def test_generate_deck_html(sample_dir: str) -> None:
...
@pytest.mark.parametrize("sample_dir", SAMPLE_DIRS)
def test_generate_ergwert_html(sample_dir: str) -> None:
    dir_path = os.path.join(TEST_DIR, sample_dir)
    ...
    title = str((soup.title and soup.title.string) or "ergwert")
...
@pytest.mark.parametrize("sample_dir", SAMPLE_DIRS)
def test_generate_tabges_html(sample_dir: str) -> None:
    dir_path = os.path.join(TEST_DIR, sample_dir)
    ...
    title = str((soup.title and soup.title.string) or "tabges")
...
@pytest.mark.parametrize("sample_dir", SAMPLE_DIRS)
def test_generate_erg_html(sample_dir: str) -> None:
    dir_path = os.path.join(TEST_DIR, sample_dir)
    ...
    title = str((soup.title and soup.title.string) or "erg")
