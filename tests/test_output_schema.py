...
data_dir = 'data'
expected_files = {
    'participants.parquet': ['placement', 'names', 'number', 'club', 'round', 'score_LW', 'score_TG', 'score_QU', 'score_PZ'],
    'judges.parquet': ['code', 'name', 'club'],
    'committee.parquet': ['role', 'name', 'club', 'raw_value'],
    'scores.parquet': ['round', 'number', 'names'],
    'final_scoring.parquet': ['placement', 'names', 'number', 'club', 'score_LW', 'score_TG', 'score_QS', 'total'],
}
