...
class FinalRoundScore:
    ...
    def __post_init__(self):
        if self.dance_name not in ALLOWED_DANCE_NAMES:
            raise ValueError(
                f"Invalid dance_name: {self.dance_name}. Must be one of {ALLOWED_DANCE_NAMES}"
            )

    def __repr__(self):
        return (
            f"FinalRoundScore(number={self.number!r}, score={self.score!r}, "
...
class Score:
    ...
    def __repr__(self):
        return (
            f"Score(number={self.number!r}, score={self.score!r}, "
            f"round_number={self.round_number!r}, "
            f"judge_code={self.judge_code!r}, dance_name={self.dance_name!r})"
        )
